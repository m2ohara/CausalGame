...
//				System.out.println("Starting drag");
			...
			public void dragStop (InputEvent event, float x, float y, int pointer, Payload payload, Target target) {
				if(!validSwipe) {
					System.out.println("Stopped invalid drag");
					if(lastValidTarget != null) {
						validSwipe = true;
						System.out.println("Dropped source at last valid target");
						lastValidTarget.drop(this, payload, x, y, pointer);
					}
					else {
						System.out.println("Enabled sprite");
...
//					System.out.println("Stopped valid drag");
				}
			}
...
//						System.out.println("Invalid drag at " + x + ", " + y);
			...
			public void drop (Source source, Payload payload, float x, float y, int pointer) {
				if(!validSwipe) {
//					System.out.println("Invalid drop at " + x + ", " + y);
					if(lastValidTarget != null) {
						validSwipe = true;
//						System.out.println("Dropped source at last valid target at "+lastValidActor.getX()+" "+lastValidActor.getY());
...
//					System.out.println("Valid drop. Dropped at " + x + ", " + y);
